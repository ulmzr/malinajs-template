(() => {
  ...
  var App_default = makeComponent(($option) => {
    ...
    {
      const $parentElement = htmlToFragmentClean(`<img src="/malinajs.svg" alt="Malina.js Logo" class="m9i9rrv"/><h1 class="m9i9rrv"> </h1><div class="m9i9rrv"><input type="text" class="m9i9rrv"/></div><div class="m9i9rrv">Edit and save file<code>src/App.xht</code>to reload</div>`, 1);
