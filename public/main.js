(() => {
  ...
  var App_default = makeComponent(($option) => {
    ...
    {
      const $parentElement = htmlToFragmentClean(`<img src="/malinajs.svg" alt="Malina.js Logo" class="m3kjsbe"/><h1 class="m3kjsbe"> </h1><div class="m3kjsbe"><input type="text" class="m3kjsbe"/></div><div class="m3kjsbe">Edit and save file<code>src/App.xht</code>to reload</div>`, 1);
